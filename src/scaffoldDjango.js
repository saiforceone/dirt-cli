...
import { scaffoldDjangoWindows } from './helpers/django/win32Helpers.js';
...
export async function scaffoldDjango(options) {
  ...
  // Branch based on OS detected (win32 vs non-win32)
  output = isWindows
    ? await scaffoldDjangoWindows(options, destination)
    : output;
  return output;
